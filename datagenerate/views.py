...
from datagenerate.methos.onlineAnalyse import onlineAnalyseLine, onlineAnalyseBox
...
def intervaldata(request):
    ...
    res['lineData'] = intervalAnalyseLine(fileName, windowsType, viewObject, viewTarget, beginTime, endTime,
                                          windowsSize)
    res['boxData'] = intervalAnalyseBox(fileName, windowsType, viewObject, viewTarget, beginTime, endTime, windowsSize)
...
def onlinetimedata(request):
    ...
    res['lineData'] = onlineAnalyseLine(fileName, deltaTime, viewObject, viewTarget, beginTime, endTime,)
    res['boxData'] = onlineAnalyseBox(fileName, deltaTime, viewObject, viewTarget, beginTime, endTime)
